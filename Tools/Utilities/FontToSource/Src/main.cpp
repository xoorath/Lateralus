...
void PrintHelp()
{
    ...
    cout << setw(24) << left << "    -help|?" << ": prints this help text then exits.\n";
    cout << setw(24) << left << "    -i input" << ": input font file\n";
    cout << setw(24) << left << "    -o output" << ": output file (ie: name.cpp or name.ixx; Default: input name .cpp)\n";
    cout << setw(24) << left << "    -s symbol" << ": symbol name. (Default: output file name before the extension.)\n";
    cout << setw(24) << left << "    -n namespace" << ": namespace name for the symbol (ie: root::inner)\n";
    cout << endl;
}
