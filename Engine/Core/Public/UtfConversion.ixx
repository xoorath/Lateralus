...
namespace Lateralus
{
    ...
    // which in turn was using Using http://www.unicode.org/versions/Unicode9.0.0/ch03.pdf page 56 as a basis.
    export
    constexpr
    array<char8_t, 4> UTF32_to_UTF8(char32_t codepoint, usz& lengthOut)
    {
    ...
    export
    constexpr
    array<char8_t, 5> UTF32_to_UTF8(char32_t codepoint)
    {
        usz unusedSize;
